...
# 最原始的数据打开有中文,按照gbk打开
input_file = 'C:/Users/Frank/Desktop/09time_series/020.csv'
...
ax = plt.subplot(111)
plt.plot(y, color='red', linewidth=2, linestyle='--', label='predicted value')
